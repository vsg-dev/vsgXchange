...
### File formats ssupported by built in ReaderWriter
    ...
    vsgXchange::all
        ...
        vsgXchange::spirv provides support for 1 extensions.
            Extensions      Supported ReaderWriter methods
            ----------      ------------------------------
            spv             read(vsg::Path, ..) write(vsg::Path, ..)

        vsgXchange::cpp provides support for 1 extensions.
            Extensions      Supported ReaderWriter methods
            ----------      ------------------------------
            cpp             write(vsg::Path, ..)
...
## Modei formats supported by optional vsgXchange::assump ReaderWriter
...
## Image and Model formats supported by optional vsgXchange::OSG ReaderWriter
